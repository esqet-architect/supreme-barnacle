...
echo "Bypassing OS constraints to resolve high-precision mathematical packages..."
pip install mpmath numpy --break-system-packages --quiet

TARGET_FILE="precise_rauzy_multifractal.py"
